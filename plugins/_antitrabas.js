...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  const fakemek = { 'key': { 'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net' }, 'message': { 'groupInviteMessage': { 'groupJid': '51962598526-1616969743@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': '𝐓𝐞𝐚𝐦 𝐅𝐫𝐢𝐞𝐧𝐝𝐬', 'jpegThumbnail': null } } };
